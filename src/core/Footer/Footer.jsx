    ...
    <footer className="bg-[#181D8A] text-white  ">
            ...
            <div className='flex gap-4 flex-wrap justify-start items-start '>
              <div className=''>
                ...
                <ul className="lg:text-base ">
                  <li><a className="hover:underline"><Link to='' className='flex gap-2 items-center'><IoLocationSharp className='text-lg'/> Singapore</Link></a></li>
      ...
      <div className='grid lg:grid-cols-3 grid-cols-1  items-center    py-3  '>
        ...
        <div className="text-center md:text-base text-xs">
          <p>© 2025 <span className='hover:underline' > <Link to="/" target='_blank'>ICCSCT </Link> </span> . All Rights Reserved.</p>
        </div>
      </div>
    </footer>
  );
