...
const Header = () => {
    ...
    return (
        <div ref={menuRef} className={`w-full fixed top-0 z-20  transition-all duration-300 ${isActive === "/" ? scrolled ? "bg-white shadow-md" : "bg-white" : "bg-white  shadow-md"} `}>
            <div className="mx-auto w-full xl:max-w-[1450px] md:max-w-[920px] flex items-center justify-between px-3">
                <div className="py-3">
                    ...
                    <Link to="/">
                        <img className={`w-40 md:mx-0 mx-auto`} src={isActive === "/" ? "/assets/images/ICCSCT.png" : "/assets/images/ICCSCT.png"} alt="logo" />
                    </Link>
                </div>

                <div className="lg:flex hidden items-center">
                    <ul className={`flex gap-18 h-full items-center justify-center inter-medium text-[18px] ${isActive === "/" ? scrolled ? 'text-black ' : 'text-black' : "text-gray-900"}`}>
                        <li >
                ...
                <Link className="xl:block hidden" to="/paper-submission" >
                    <div className="flex items-center gap-2 group bg-gradient-to-r from-[#025DFB] to-[#04C1F3] cursor-pointer  px-3 py-2 rounded-md">
                        <button className=" inter-semibold text-lg text-white cursor-pointer">Register Now
                        </button>
