  ...
  return (
    <>
      <div className="bg-[url('/assets/images/Bgimage.jpg')] bg-cover bg-right xl:h-screen  flex items-center ">
        <div className="xl:max-w-[1450px] md:max-w-[920px] mx-auto 2xl:mx-auto xl:mx-0 px-3 lg:mt-[70px] xl:mt-16 mt-20">
          <div className="grid 2xl:grid-cols-2 grid-cols-1 gap-4 place-items-center py-5   ">
            <div>
              <div className="flex flex-col 2xl:gap-12 gap-5 items-center xl:items-start">
                <div className="space-y-3">
                  <p className="inter-semibold lg:text-[18px] text-[16px] text-white">Building the Next-Gen Cloud Era</p>
                  <h1 className="inter-semibold 2xl:text-[42px] xl:text-[35px] md:text-[25px] text-[20px] text-white  xl:max-w-2xl 2xl:max-w-none">International Conference on Computational Systems and Cloud Technologies</h1>
                  <div className="block xl:hidden flex  justify-center lg:mt-10 mt-4">
                    <img src="/assets/images/Hero2.jpg" alt="Cloud Tech" className="w-[600px] rounded-lg object-cover border-6 border-white" loading="lazy" />
                  </div>
                </div>
                <div className="space-y-8">

                  <p className="inter-regular sm:text-base md:text-lg lg:text-[16px] text-gray-300 leading-[30px] text-justify   xl:max-w-[38rem]">
                  ...
                  <div className="flex flex-wrap gap-5 ">
                    ...
                    <div className="flex items-center gap-1 px-3 py-2 rounded-md border-2 border-white min-w-[158px]">
            ...
            <div className="hidden xl:block 2xl:hidden">
              <img
                ...
                alt="cloud tech"
                className="absolute right-0 bottom-28  xl:max-w-[40rem]  object-contain" loading="lazy"
              />
            </div>
            <div className="hidden 2xl:block  ">
              <img
                src="/assets/images/ICCSCThero.png"
                alt="cloud tech"
                className="absolute right-0 bottom-28  2xl:max-w-[50rem]  object-contain" loading="lazy"
              />
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 justify-center place-items-center lg:gap-10 gap-10 lg:mt-12 mt-6">
          <div>
            ...
            <div className="mt-4 lg:mt-5 flex flex-col gap-6">
              ...
              <Link to="/scope" className=" flex justify-center">
                <div className="flex items-center gap-2 group bg-gradient-to-r from-[#025DFB] to-[#04C1F3] cursor-pointer px-3 py-2 rounded-md w-fit  ">
                  <button className="inter-medium md:text-lg text-white cursor-pointer">Read More</button>
                  <TbCircleArrowRightFilled className="text-white text-2xl transform transition-all duration-300 group-hover:rotate-45" />
                </div>
      ...
      <div className="xl:max-w-[1450px]  md:max-w-[920px] mx-auto px-3 lg:mt-15 mt-10">
        ...
        <div className="grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-2 grid-cols-2 place-items-center mt-10 mx-auto gap-5 h-full max-w-[70rem]">
          ...
          <div className="bg-[#181D8A] py-5 px-7 border-b-5 border-b-[#04C1F3] rounded-t-full min-w-[134px]  h-full">
            <div className="flex flex-col gap-1 items-center">
              <div className="bg-white rounded-full w-15 h-15  flex items-center justify-center">
                <img src="/assets/images/stat2.png" alt="stats1" className="flex-shrink-0 w-10" loading="lazy" />
              </div>
              <div className="flex flex-col items-center justify-center">
          ...
          <div className="bg-[#181D8A] py-5 px-7 border-b-5 border-b-[#04C1F3] rounded-t-full  min-w-[134px] h-full ">
            <div className="flex flex-col gap-1 items-center">
              <div className="bg-white rounded-full w-15 h-15  flex items-center justify-center">
                <img src="/assets/images/stat3.png" alt="stats1" className="flex-shrink-0 w-9" loading="lazy" />
              </div>
              <div className="flex flex-col items-center justify-center">
          ...
          <div className="bg-[#181D8A] py-5 px-7 border-b-5 border-b-[#04C1F3] rounded-t-full min-w-[134px]  h-full">
            <div className="flex flex-col gap-1 items-center">
              <div className="bg-white rounded-full w-15 h-15  flex items-center justify-center">
                <img src="/assets/images/stat4.png" alt="stats1" className="flex-shrink-0 w-10" loading="lazy" />
              </div>
              <div className="flex flex-col items-center justify-center">
