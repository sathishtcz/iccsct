...
try {
    ...
    $mail->setFrom('info.iccsct@gmail.com', 'Contact Submission System');
    $mail->addAddress('info.iccsct@gmail.com', 'Contact Submissions');
    ...
    $mail->isHTML(true);
    $mail->Subject = 'ICCSCT Contact Submission';
