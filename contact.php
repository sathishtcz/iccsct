...
try {
    ...
    $mail->SMTPAuth   = true;
    $mail->Username   = 'info.iccsct@gmail.com';
    $mail->Password   = 'huyx oswu xwgo xupj'; // App Password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port       = 587;

    // Email setup to admin
    $mail->setFrom('info.iccsct@gmail.com', 'ICCSCT Enquiry');
    $mail->addAddress('info.iccsct@gmail.com', 'ICCSCT Enquiry');
    ...
    $replyMail->Username   = 'info.iccsct@gmail.com';
    $replyMail->Password   = 'huyx oswu xwgo xupj';
    $replyMail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $replyMail->Port       = 587;

    $replyMail->setFrom('info.iccsct@gmail.com', 'ICCSCT Team');
    $replyMail->addAddress($_POST['email'], $_POST['firstname'] . ' ' . $_POST['secondname']);
    $replyMail->isHTML(true);
    $replyMail->Subject = 'Thank you for your enquiry - ICCSCT 2025';
    ...
    $replyMail->Body = '
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
            ...
            <p>Warm regards,<br>ICCSCT 2025 Team</p>
        </div>
    ';
