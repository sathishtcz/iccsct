...
$required_fields = ['Paper_Title', 'Author_FUll_Name','Mobile_Number','Email_Address', 'Institution_Name', 'Paper_Track'];
$missing_fields = [];
...
try {
    ...
    $mail->Password   = 'huyx oswu xwgo xupj';
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
    $mail->Port       = 587;

    $mail->setFrom('info.iccsct@gmail.com', 'Paper Submission System');
    $mail->addAddress('info.iccsct@gmail.com', 'Paper Submissions');
    ...
    $mail->isHTML(true);
    $mail->Subject = 'ICCSCT Paper Submission - ' . htmlspecialchars($_POST['Paper_Title']);
